defmodule BeansWeb.CoreComponents do
        ...
        <div class="flex min-h-full items-center justify-center">
          <div class="w-full  p-4 sm:p-6 lg:py-8">
            <.focus_wrap
              ...
              class="mx-20 hidden relative rounded-2xl bg-white p-14 shadow-lg shadow-zinc-700/10 ring-1 ring-zinc-700/10 transition"
            >
  ...
  def button(assigns) do
    ...
    <button
      type={@type}
      class={[
        "btn btn-primary phx-submit-loading:opacity-75 rounded-lg",
        @class
      ]}
      {@rest}
    >
  ...
  attr :class, :string, default: nil, doc: "additional class attributes"
  ...
  def input(%{type: "select"} = assigns) do
    ...
    <div phx-feedback-for={@name}>
      ...
      <select id={@id} name={@name} class="select select-bordered" multiple={@multiple} {@rest}>
